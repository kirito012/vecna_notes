---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/humanoid/kuo-toa-whip/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/kuo-toa"],"noteIcon":""}
---
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 5 (1d6\
    \ + 2) piercing damage. If the target is a Medium or smaller creature, it is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
