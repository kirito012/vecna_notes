---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/plant/astral-blight-lox/","tags":["ttrpg-cli/compendium/src/5e/lox","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/plant"],"noteIcon":""}
---
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 6\
    ...
    \ it is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 13).\
    \ Until this grapple ends, the target takes 3 (1d6) cold damage at the start\
    \ of each of its turns. The blight has two vines, each of which can grapple one\
    \ creature."
