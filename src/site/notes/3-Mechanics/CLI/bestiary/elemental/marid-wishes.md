---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/elemental/marid-wishes/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"noteIcon":""}
---

# [Marid (Wishes)](3-Mechanics\CLI\bestiary\elemental/marid-wishes.md)
...
- "desc": "The genie power to grant wishes is legendary among mortals. Only the most\
    ...
    \ the genie states a desired effect to it. The genie can then cast the [wish](3-Mechanics/CLI/spells/wish.md)\
...
- "desc": "The marid magically shoots water in a 60-foot line that is 5 feet wide.\
    ...
    \ pushed up to 20 feet away from the marid and knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
