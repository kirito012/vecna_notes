---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/elemental/djinni-disguises/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"noteIcon":""}
---

# [Djinni (Disguises)](3-Mechanics\CLI\bestiary\elemental/djinni-disguises.md)
...
- "desc": "The djinni's innate spellcasting ability is Charisma (spell save DC 17,\
    ...
    \ elemental](3-Mechanics/CLI/spells/conjure-elemental.md) ([air elemental](3-Mechanics/CLI/bestiary/elemental/air-elemental.md)\
    \ only), [creation](3-Mechanics/CLI/spells/creation.md), [gaseous form](3-Mechanics/CLI/spells/gaseous-form.md),\
    ...
    \ walk](3-Mechanics/CLI/spells/wind-walk.md), [true polymorph](3-Mechanics/CLI/spells/true-polymorph.md)\
