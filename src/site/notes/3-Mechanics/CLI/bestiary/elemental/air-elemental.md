---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/elemental/air-elemental/","tags":["ttrpg-cli/compendium/src/5e/mm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"noteIcon":""}
---
...
- "desc": "Each creature in the elemental's space must make a DC 13 Strength saving\
    ...
    \ up 20 feet away from the elemental in a random direction and knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
