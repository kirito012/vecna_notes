---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/npc/zastra-veor/","tags":["ttrpg-cli/compendium/src/5e/veor","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/gith"],"noteIcon":""}
---
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 13 (2d6\
    ...
    \ On a critical hit against a target in an astral body (as with the [astral projection](3-Mechanics/CLI/spells/astral-projection.md)\
    \ spell), Zastra can cut the silvery cord that tethers the target to its material\
    \ body, instead of dealing damage."
  "name": "Silver Greatsword"
"source":
- "VEoR"
"image": "3-Mechanics/CLI/bestiary/npc/token/zastra-veor.webp"
```
^statblock