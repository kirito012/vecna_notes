---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/npc/big-momma-lox/","tags":["ttrpg-cli/compendium/src/5e/lox","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/monstrosity"],"noteIcon":""}
---
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 45\
    ...
    \ 10 feet of Big Momma. If Big Momma dies, a swallowed creature is no longer [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Big Momma's eye emits an [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible),\
    ...
    \ The target must succeed on a DC 16 Wisdom saving throw or be [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
