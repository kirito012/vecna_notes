---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/npc/shanzezim-veor/","tags":["ttrpg-cli/compendium/src/5e/veor","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"noteIcon":""}
---
...
- "desc": "Shanzezim magically shoots water in a 60-foot line that is 5 feet wide.\
    ...
    \ pushed up to 20 feet away from Shanzezim and knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
...
"source":
- "VEoR"
"image": "3-Mechanics/CLI/bestiary/npc/token/shanzezim-veor.webp"
```
^statblock