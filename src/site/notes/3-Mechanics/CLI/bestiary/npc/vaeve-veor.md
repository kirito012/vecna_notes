---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/npc/vaeve-veor/","tags":["ttrpg-cli/compendium/src/5e/veor","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/elf"],"noteIcon":""}
---
...
- "desc": "Vaeve is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "Vaeve has advantage on saving throws against being [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed),\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "Vaeve magically summons a [quasit](3-Mechanics/CLI/bestiary/fiend/quasit.md),\
...
"source":
- "VEoR"
"image": "3-Mechanics/CLI/bestiary/npc/token/vaeve-veor.webp"
```
^statblock