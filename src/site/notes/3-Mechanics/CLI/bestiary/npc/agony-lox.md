---
{"dg-publish":true,"permalink":"/3-mechanics/cli/bestiary/npc/agony-lox/","tags":["ttrpg-cli/compendium/src/5e/lox","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/undead"],"noteIcon":""}
---
...
- "desc": "One humanoid that Agony can see within 5 feet of it must succeed on a DC\
    ...
    \ the target is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
    ...
    \ body drops to 0 hit points, Agony ends it as a bonus action, or Agony is turned\
    \ or forced out by an effect like the [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md)\
