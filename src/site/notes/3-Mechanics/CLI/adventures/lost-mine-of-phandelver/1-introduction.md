---
{"dg-publish":true,"permalink":"/3-mechanics/cli/adventures/lost-mine-of-phandelver/1-introduction/","tags":["ttrpg-cli/compendium/src/5e/lmop"],"noteIcon":""}
---
...
> - **Pay attention.** Make sure you look around the table occasionally to see if the game is going well. If everyone seems to be having fun, relax and keep going. If the fun is waning, it might be time for a break, or you can try to liven things up.  { #rules-to-game-by}
...
| cp = copper piece(s) | - |{ #abbreviation-abbreviation}
...
> 
> A character can have only one inspiration at a time.{ #roleplaying-and-inspiration}
