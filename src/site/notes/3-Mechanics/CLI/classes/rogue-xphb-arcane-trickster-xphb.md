---
{"dg-publish":true,"permalink":"/3-mechanics/cli/classes/rogue-xphb-arcane-trickster-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/rogue/arcane-trickster"],"noteIcon":""}
---
...
The Arcane Trickster Spellcasting table shows how many spell slots you have to cast your level 1+ spells. You regain all expended spell slots when you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).
...
When you cast [Mage Hand](3-Mechanics/CLI/spells/mage-hand-xphb.md), you can cast it as a [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md), and you can make the spectral hand [Invisible](3-Mechanics/CLI/rules/conditions.md#Invisible). You can control the hand as a [Bonus Action](3-Mechanics/CLI/rules/variant-rules/bonus-action-xphb.md), and through it, you can make Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) checks.

### Magical Ambush (Level 9)

If you have the [Invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) condition when you cast a spell on a creature, it has [Disadvantage](3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on any saving throw it makes against the spell on the same turn.
...
Immediately after a creature casts a spell that targets you or includes you in its area of effect, you can take a [Reaction](3-Mechanics/CLI/rules/variant-rules/reaction-xphb.md) to force the creature to make an Intelligence saving throw. The DC equals your spell save DC. On a failed save, you negate the spell's effect against you, and you steal the knowledge of the spell if it is at least level 1 and of a level you can cast (it doesn't need to be a Wizard spell). For the next 8 hours, you have the spell prepared. The creature can't cast it until the 8 hours have passed.

Once you steal a spell with this feature, you can't use this feature again until you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).