---
{"dg-publish":true,"permalink":"/3-mechanics/cli/books/xanathars-guide-to-everything/3-dungeon-masters-tools/","tags":["ttrpg-cli/compendium/src/5e/xge"],"noteIcon":""}
---
...
> 
> Traps are most effective when their presence comes as a surprise, not when they appear so often that the characters spend all their effort watching out for the next one.{ #making-traps-meaningful}
...
> 
> Because many of the table results call for more than one magic item, those forty-five rolls will result in the characters obtaining roughly one hundred items. The optional system described here yields the same number of items, distributed properly throughout the spectrum of rarity, while enabling you to control exactly which items the characters have a chance of acquiring.{ #behind-the-design-magic-item-distribution}
