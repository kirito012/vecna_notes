---
{"dg-publish":true,"permalink":"/3-mechanics/cli/books/players-handbook-2014/05-personality-and-background/","tags":["ttrpg-cli/compendium/src/5e/phb"],"noteIcon":""}
---
...
> 
> Tika and Artemis are both human and both fighters (with some experience as rogues), possessing similarly high Strength and Dexterity scores, but there the similarity ends.{ #tika-and-artemis-contrasting-characters}
...
![Random Height and Weight](3-Mechanics/CLI/tables/random-height-and-weight.md)
...
![Standard Languages](3-Mechanics/CLI/tables/standard-languages.md)

![Elvish Alphabet](3-Mechanics/CLI/books/players-handbook-2014/img/c4elvishalphabet.webp#center)

![Exotic Languages](3-Mechanics/CLI/tables/exotic-languages.md)
...
> 
> Artemis Entreri is completely walled off from any personal relationship and just wants to be left alone.{ #tika-and-artemis-personal-characteristics}
